...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      this.setState({ loaded: true, tokenSaleAddress: this.myTokenSale._address, userTokens: this.updateUserTokens });
    } catch (error) {
